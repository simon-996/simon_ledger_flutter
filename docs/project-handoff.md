...
> 实施历史与逐项进度见 `docs/backend-integration-todolist.md`，高频使用体验优化见 `docs/high-frequency-user-optimization-todolist.md`，UI 方向与新增组件规范见 `docs/ui-direction.md`，真实服务验收步骤见 `docs/backend-acceptance-checklist.md`。
